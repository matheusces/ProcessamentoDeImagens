...
AudioSegment.from_wav("audio2.wav").export("audio2_2.mp3", format="mp3", bitrate="128k")
# AudioSegment.from_wav("MaisUmaSemana.wav").export("MUS2_2.mp3", format="mp3", bitrate="128k")
path_name = os.getcwd() + '/audio2_2.mp3'
...
wavfile.write(filename="audio2.2_dct.mp3", rate=fs, data=data)
